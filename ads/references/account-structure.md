...
**When to increase or decrease is a performance judgment, made in `campaign-analysis`'s comparative-judgment layer (paid).** This file only answers "once you've decided to adjust, by how much and how often."
